...
{
    loadFromFile("assets/assets/sprites/rock.png", renderer);
    loadFromFile("assets/assets/sprites/branch.png", renderer);
}

void Rock::update(int &score, bool &isHittingWall)
{
